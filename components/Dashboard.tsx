...
import { ArrowRightIcon, WalletIcon } from './AppIcons';
import { CashFlowService, CashFlowSummary } from '../services/CashFlowService';
    ...
    <div className="space-y-10 pb-10 animate-fadeIn">
      ...
      <section className="bg-slate-950 p-8 rounded-[2.5rem] text-white shadow-2xl shadow-indigo-100 relative overflow-hidden">
        <div className="relative z-10">
          <span className="text-xs font-black uppercase tracking-[0.2em] text-slate-500 mb-2 block">
            Saldo em Conta
          </span>
        ...
        <div className="absolute top-0 right-0 p-8 opacity-10 pointer-events-none">
          <WalletIcon className="w-28 h-28 md:w-32 md:h-32" />
        </div>
      </section>
